...
time of diagnosis". To obtain the dataset:
...
The *gordon* dataset contains 12533 gene expression measurements on 181 tissue samples: 31 MPM and 150 ADCA. These data derive from @gordon2002translation Cancer Research paper which provides evidence that this technique can be accurate in this and other clinical scenarios. To obtain the dataset:  
